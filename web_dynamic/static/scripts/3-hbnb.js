  ...
  function search (theAmenities) {
    ...
    placesSearch.done(function (data) {
      for (let i = 0; i < data.length; i++) {
        ...
        const titleBox = $(
          "<div class='title_box'><h2></h2><div class='price_by_night'></div></div>"
        );
        ...
        const guest = $("<div class='max_guest'></div>").html(
          maxGuest + guestString
        );
        ...
        const rooms = $("<div class='number_rooms'></div>").html(
          maxRooms + roomString
        );
        ...
        const bathrooms = $("<div class='number_bathrooms'></div>").html(
          maxBathrooms + bathString
        );
